...
// FIX: Changed icon prop type from React.ReactNode to React.ReactElement to provide a more specific type for React.cloneElement.
const SummaryCard: React.FC<{ title: string; value: number; change?: number; changePercent?: number; icon: React.ReactElement; isPositive?: boolean }> = ({ title, value, change, changePercent, icon, isPositive }) => {
